...
public class StringUtil {
	...
	public static void convertClob(List<Bus> list, String fieldName) {
		
		Object clobobj;
		for (Bus bus : list) {
			clobobj = ((Bus) bus).get(fieldName.toLowerCase());
			((Bus) bus).put(fieldName.toLowerCase(), clobobj);
		}

	}

	public static void convertClob(Bus bus, String fieldName){
		Object cloblike = ((Bus) bus).get(fieldName.toLowerCase());
		((Bus) bus).put(fieldName.toLowerCase(), cloblike);
