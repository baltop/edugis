...
<div id="contGen" class="s_contain">
	...
	<form name="formx" id="formx" action="" method="post" enctype="multipart/form-data">
		...
		<input type="hidden" id="review_id" name="review_id" value="${reviewItem.review_id}" />
		...
		<table width="880" cellpadding="6" cellspacing="0" border="0" class="tb_03">
			...
			<tr>
				...
				<td><input name="review_title" id="review_title" type="text" size="60" value="${reviewItem.review_title }" maxlength="100" class="input01 essence" /></td>
			</tr>
			<tr>
				...
				maxlength="1600" onkeyup="return textarea_maxlength(this);" onChange="return textarea_maxlength(this);" >${reviewItem.review_content}</textarea></td>
			</tr>
...
<!--
	...
	function fn_insert() {
		...
		if (confirm('<spring:message code="common.regist.msg" />')) {
			document.formx.action = "${wc}/saveProj.do";
