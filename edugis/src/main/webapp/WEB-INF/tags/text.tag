...
<%
	...
	if ( "insert".equals(method) || "update".equals(method) ){
		...
		out.print("<input name='" + id + "' id='" + id + "' type='text' class='input01 "+className+"' size='" + size + "' value='"+value+"' maxlength='" + maxlength + "' "+ readonly +"/>"  );
	}
	else if ("view".equals(method) ){
		out.print("<span class='"+className+"'>"+value+"</span>");
	}
	else {
